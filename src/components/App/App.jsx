...
let App = props => {
  ...
  return (
    ...
    >
      ...
      <button
        className={cx("app__toggle", { "app__toggle--active": state.isOpen2 })}
        onClick={() => toggle(2)}
      >
        toggle
      </button>
      ...
      <C3
        ...
        render={collapseState => (
          <div className="app__content">
            ...
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
            aliquip ex ea commodo consequat. <a href="/">dummy link</a>
          </div>
        )}
      />

      <button
        className={cx("app__toggle", { "app__toggle--active": state.isOpen4 })}
        onClick={() => toggle(4)}
      >
        toggle
      </button>
